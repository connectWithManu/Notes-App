...
import com.manu.notesapp.fragments.HomeFragmentDirections
import com.manu.notesapp.model.Notes

class NotesAdapter(val context: Context, var notesList: List<Notes>): RecyclerView.Adapter<NotesAdapter.NotesVH>() {
